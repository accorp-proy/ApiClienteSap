...
public class UsuarioBean extends BaseBean implements Serializable {
	...
	public void guardarUsuario() {
		...
		try {
			...
			showInfo("Notificaci�n", FacesMessage.SEVERITY_INFO, null, "Datos del usuario guardado");
			init();
		} catch (EntidadNoGrabadaException e) {
			e.printStackTrace();
			showInfo("Notificaci�n", FacesMessage.SEVERITY_ERROR, null, "Se produjo un error al guardar el usuario");
		}
