...
public class LoginBean extends BaseBean {
	...
	@EJB
	private ISrvNotificacion notificacion;

	@Override
	public void init() {
		switch (appMain.getErrLog()) {
		case 1:
			getRequestContext().execute("doGrowl('Debe ingresar usuario y contrase�a')");
			break;
		case 2:
			getRequestContext().execute("doGrowl('Verifique que su nombre de usuario y contrase�a sea el correcto')");
			break;
		}
		appMain.setErrLog(0);
	}
