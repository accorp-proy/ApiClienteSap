...
public enum Mensajes {
	...
	_GRABAR("Informaci�n guardada exitosamente"),
	 _ERRORGRABAR("Error al grabar"),
	 _DATATABLE("No existe coincidencias"),
	 _ERRORCEDULA("Error: no se encuentra a Identificaci�n y/o no hay conexion a internet"),
	 ...
	 _ERROR_CEDULA("Error: C�dula debe contener 10 digitos"),
